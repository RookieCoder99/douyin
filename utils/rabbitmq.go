...
const MQURL = "amqp://admin123:BDCamp2022&NO34@180.184.74.173/classhelper"
const QUEUE_NAME = "classhelper_queue"
const TOPIC_NAME = "classhelper_topic"
const EXCHANGE_NAME = "classhelper_exchange"
const ROUTING = "classhelper_routing"
...
func InitRabbitmq() *Session {
	Rmq = New(QUEUE_NAME, MQURL)
	//return Rmq
